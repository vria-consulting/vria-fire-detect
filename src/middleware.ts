...
export const config = {
  ...
  matcher: [
    "/((?!api|veille|google|opendata|embed|fx|ogfire|ogbilan|_next|sw\\.js|brand|icon|apple-icon|favicon|manifest|sitemap|robots|llms|og\\.png|.*\\.(?:png|svg|ico|txt|webmanifest|xml|json)).*)",
  ],
};
