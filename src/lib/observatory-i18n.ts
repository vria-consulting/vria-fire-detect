...
export const OBS = {
  fr: {
    ...
    introMonth: (name: string, month: string, total: number, updated: string) =>
      `${name}, ${month} : ${total} événements de détection archivés sur la période couverte, selon les seuils kanari. Mise à jour : ${updated}.`,
    quote: (name: string, month: string, total: number, active: number, maxFrp: number) =>
      `« En ${month}, kanari a archivé ${total} événements de détection (${name}), dont ${active} encore actifs à la dernière mise à jour. Ce total ne représente pas des incendies physiques distincts confirmés. Puissance radiative maximale observée : ${Math.round(maxFrp)} MW. »`,
    ...
    cards: { total: "événements archivés", active: "encore actifs", witnesses: "avec témoins vérifiés", aircraft: "avec moyens aériens observés", maxFrp: "puissance max (MW)" },
    ...
    citeText: (name: string, month: string, total: number) =>
      `kanari (2026). Événements de détection archivés, ${name}, ${month} : ${total} enregistrements. https://kanari.io — consulté le`,
    ...
    openData: "Télécharger les données (CSV, CC BY 4.0)",
    monthsTitle: "Mois couverts par l'archive",
    colMonth: "Mois",
    colFires: "Événements archivés",
    ...
    ogAlt: (name: string, month: string) => `Bilan des feux de forêt, ${name}, ${month} (kanari)`,
  },
  en: {
    ...
    introMonth: (name: string, month: string, total: number, updated: string) =>
      `${name}, ${month}: ${total} detection events archived over the covered period using kanari thresholds. Updated ${updated}.`,
    quote: (name: string, month: string, total: number, active: number, maxFrp: number) =>
      `"In ${month}, kanari archived ${total} detection events in ${name}, with ${active} still active at the last update. This is not a count of distinct confirmed physical wildfires. Peak observed fire radiative power: ${Math.round(maxFrp)} MW."`,
    ...
    cards: { total: "archived events", active: "still active", witnesses: "with verified witnesses", aircraft: "with aircraft observed", maxFrp: "peak power (MW)" },
    ...
    citeText: (name: string, month: string, total: number) =>
      `kanari (2026). Archived detection events, ${name}, ${month}: ${total} records. https://kanari.io — accessed`,
    ...
    openData: "Download the data (CSV, CC BY 4.0)",
    monthsTitle: "Months covered by the archive",
    colMonth: "Month",
    colFires: "Archived events",
    ...
    ogAlt: (name: string, month: string) => `Wildfire report, ${name}, ${month} (kanari)`,
  },
  es: {
    ...
    introMonth: (name: string, month: string, total: number, updated: string) =>
      `${name}, ${month}: ${total} eventos de detección archivados en el periodo cubierto, según los umbrales de kanari. Actualización: ${updated}.`,
    quote: (name: string, month: string, total: number, active: number, maxFrp: number) =>
      `« En ${month}, kanari archivó ${total} eventos de detección en ${name}, con ${active} todavía activos en la última actualización. No es un recuento de incendios físicos distintos confirmados. Potencia radiativa máxima observada: ${Math.round(maxFrp)} MW. »`,
    ...
    cards: { total: "eventos archivados", active: "todavía activos", witnesses: "con testigos verificados", aircraft: "con medios aéreos observados", maxFrp: "potencia máx. (MW)" },
    byDay: "Focos por día",
    ...
    citeText: (name: string, month: string, total: number) =>
      `kanari (2026). Eventos de detección archivados, ${name}, ${month}: ${total} registros. https://kanari.io — consultado el`,
    ...
    openData: "Descargar los datos (CSV, CC BY 4.0)",
    monthsTitle: "Meses cubiertos por el archivo",
    colMonth: "Mes",
    colFires: "Eventos archivados",
    ...
    ogAlt: (name: string, month: string) => `Balance de incendios forestales, ${name}, ${month} (kanari)`,
  },
  pt: {
    ...
    introMonth: (name: string, month: string, total: number, updated: string) =>
      `${name}, ${month}: ${total} eventos de detecção arquivados no período coberto, segundo os limiares do kanari. Atualização: ${updated}.`,
    quote: (name: string, month: string, total: number, active: number, maxFrp: number) =>
      `« Em ${month}, o kanari arquivou ${total} eventos de detecção em ${name}, com ${active} ainda ativos na última atualização. Não é uma contagem de incêndios físicos distintos confirmados. Potência radiativa máxima observada: ${Math.round(maxFrp)} MW. »`,
    ...
    cards: { total: "eventos arquivados", active: "ainda ativos", witnesses: "com testemunhas verificadas", aircraft: "com meios aéreos observados", maxFrp: "potência máx. (MW)" },
    byDay: "Focos por dia",
    ...
    citeText: (name: string, month: string, total: number) =>
      `kanari (2026). Eventos de detecção arquivados, ${name}, ${month}: ${total} registros. https://kanari.io — acessado em`,
    ...
    openData: "Baixar os dados (CSV, CC BY 4.0)",
    monthsTitle: "Meses cobertos pelo arquivo",
    colMonth: "Mês",
    colFires: "Eventos arquivados",
    ...
    ogAlt: (name: string, month: string) => `Balanço de incêndios florestais, ${name}, ${month} (kanari)`,
  },
} as const;
