...
export async function generateMetadata({
  ...
  return {
    title: `Bilan des feux de forêt du ${frLongDate(date)} : départs détectés dans le monde | kanari`,
...
export default async function BilanPage({
  ...
  const fires = await listFiresBetween(`${date}T00:00:00Z`, `${nextDay(date)}T00:00:00Z`);
