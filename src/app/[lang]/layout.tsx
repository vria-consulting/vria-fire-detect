  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        logo: {
          "@type": "ImageObject",
          url: "https://kanari.io/icon-512.png",
          width: 512,
          height: 512,
        },
        description: t.metaDescription,
        slogan: l === "fr" ? "Le canari chante avant la sirène." : "The canary sings before the siren.",
        email: "contact@kanari.io",
        founder: { "@id": "https://kanari.io/#vincent" },
        parentOrganization: {
          "@type": "Organization",
          name: "VRIA Consulting",
          url: "https://vria-consulting.fr",
          identifier: { "@type": "PropertyValue", propertyID: "SIREN", value: "989 005 855" },
        },
        // Profils et depots publics de kanari : les moteurs et les assistants
        // relient l'entite a ses presences externes.
        sameAs: [
          "https://github.com/vria-consulting/vria-fire-detect",
          "https://www.youtube.com/channel/UCbGPRoyCqUInu8t0WgriKIw",
          "https://doi.org/10.5281/zenodo.22078610",
          "https://www.data.gouv.fr/datasets/feux-de-foret-detectes-par-satellite-et-temoins-verifies-kanari",
          "https://www.kaggle.com/datasets/vincentryckbosch/kanari-wildfire-archive-satellite-witnesses",
          "https://www.npmjs.com/package/kanari-fires",
          "https://smithery.ai/servers/vryckbosch/kanari-wildfires",
        ],
      },
      {
        "@type": "Person",
        "@id": "https://kanari.io/#vincent",
        name: "Vincent Ryckbosch",
        url: "https://ryckbosch.fr",
        jobTitle: l === "fr" ? "Fondateur de kanari" : "Founder of kanari",
        worksFor: { "@id": "https://kanari.io/#org" },
        sameAs: ["https://ryckbosch.fr", "https://vria-consulting.fr", "https://github.com/vria-consulting"],
      },
    ],
  };
}
